    ...
    <>
        <section className='homepage font-sourceSans3'>
            ...
            {/* <header className="font-sourceSans3"> */}
                ...
                <div className='intro'>
                    ...
                    <ul className="" style={{ paddingLeft: "3rem", listStyleType: "circle" }}>
                        ...
                        <li className="text-lg lg:text-2xl text-red-950 font-300 leading-relaxed">
                            <strong>Contributing to Dr. Mayank Kejriwal's Studies in Global Human Trafficking at USC Artificial Intelligence and Complex Systems (AICS)</strong>
                        ...
                        <li className="text-lg lg:text-2xl text-red-950 font-300 leading-relaxed">
                            Currently coding: CV Satellite Image Analysis, <Link href="https://www.authentixapp.com/" className='font-medium underline'>Authentix</Link>, <Link href="https://www.blendify.app/" className='font-medium underline'>spotify blender</Link>
                            {/* <br></br>
            ...
            <section className='extras'>
                <div>
                    <h2>Extras</h2>
                    <p>Other than coding, I seem to have accumulated one too many pastimes for just one person: tennis, producing music, playing violin concertos, sketching naturalism, hiking, experimenting with neoclassical painting, playing chess, kickboxing... </p>
