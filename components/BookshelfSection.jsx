...
const BOOK_NOTES = {
  ...
  'The Trial': 'Initially, I found this book absolutely distasteful. The narrative is a fragmented fever dream where reality is nonsensical. The constant friction between K and his unintelligible surroundings is really frustrating, yet that is exactly the point. Kafka likes using this uncomfortable air to deliver his trademark existential dread. This book in particular really conveys Kafka\'s view on the powerlessness of an individual against opaque, dehumanizing systems. \n\nAfter having read more of his work, I’ve grown to appreciate his not exactly monotone, but more so sterile, aphoristic prose and dark humor. Even his \'romantic\' writing (specifically the Letters to Milena) has a disquieting intensity. There is a certain brutalism and dehumanizing effect in his style that gets me. He avoids overt emotionalism and fluff words, instead cutting straight to the core. It is a plain text and condensed approach to the human condition that I\’ve found mimics my own way of communicating: honest and unambiguous.',
  ...
  'Notes from Underground': 'I think I\'m just really into literary loners that prefer alienation and introspection over life. I really like Dostoevsky in general so my next read after finishing my Retrieval-Augmented Generation reading/study project will most likely be The Brothers Karamazov.',
// 'Fahrenheit 451': '',
...
const BookshelfSection = () => {
  ...
  const books = [
    ...
    { title: 'The Trial', color: '#3E4E3F', author: 'Franz Kafka' },              // Deep Olive Green
